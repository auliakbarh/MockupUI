        ...
        .then(() => {
          ...
          SQLite.openDatabase(
            ...
            .then(DB => {
              ...
              db.executeSql('SELECT 1 FROM Buma LIMIT 1')
                .then(() => {
                ...
                .catch(error => {
                  ...
                  db.transaction(tx => {
                    tx.executeSql(
                      'CREATE TABLE IF NOT EXISTS Buma (id, judulRequest, detailLaporan, lokasi, subLokasi, detailLokasi, createdAt, createdBy, updatedAt, updatedBy, deletedBy)',
                    );
                  })
                    .then(() => {
